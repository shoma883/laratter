        ...
        <div class="p-6 text-gray-900 dark:text-gray-100">
          ...
          <div class="mb-4">
              @if ($user->profile_image)
                  <img src="{{ asset('storage/' . $user->profile_image) }}" alt="{{ $user->name }}'s Profile Image" class="w-24 h-24 rounded-lg">
              @else
                  <img src="{{ asset('storage/default/profile_image.png') }}" alt="Default Image" class="w-24 h-24 rounded-full">
              @endif
          </div>
          

          <p class="text-gray-800 dark:text-gray-300 text-lg">{{ $user->name }}</p>
          <p class="text-gray-600 dark:text-gray-300 text-base">{{ $user->bio }}</p>
